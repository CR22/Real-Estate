...
public class Course implements Comparable<Course> {
    ...
    /**
     * This method is used to print course variables
     * @return Course Name, Course Number, Number of Credits,
     *         Letter Grade, and Area of Study
     */
    public String toString() {
    	return mCourseName + " " + mCourseNumber + " " + mNumberOfCredits 
    			           + " " + mLetterGrade + " " + mAreaOfStudy;
    }
	...
	public int compareTo (Course otherCourse) {
		...
		if (mNumberOfCredits < otherCourse.mNumberOfCredits)
			return -1;
		if (mNumberOfCredits > otherCourse.mNumberOfCredits)
			return 1;
		return 0;
